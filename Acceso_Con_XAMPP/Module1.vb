...
Module Module1
    Public conectarmysql As MySqlConnection 'conecta sql'
    Public conectarmysqlcomand As MySqlCommand ' comandos sql'

    Public Function strdconection() As MySqlConnection
        Return New MySqlConnection("server=localhost; user id= root; password=; database=ejercicio1;")
    End Function 'para tener una funcion de tipo publica'

    Public strcon As MySqlConnection = strdconection()
    Public result As String
    Public cmd As New MySqlCommand
    Public da As New MySqlDataAdapter
    Public dt As New DataTable

    Public Sub create(ByVal sql As String) 'crea usuairos y contraseñas desde aca'
        Try
            strcon.Open()
            With cmd
                .Connection = strcon
                .CommandText = sql
                result = cmd.ExecuteNonQuery 'Que lo ejecute en el XAMPP'
                If result = 0 Then
    ...
    Public Sub supdate(ByVal sql As String) 'crea usuairos y contraseñas desde aca'
        Try
            strcon.Open()
            With cmd
                .Connection = strcon
    ...
    Public Sub deletew(ByVal sql As String)
        Try
            ...
            With cmd
                ...
                If result = 0 Then
                    MessageBox.Show("Error al eliminar los datos", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Else
    ...
    Public Sub GenerarPDFUsuarios(ByVal consulta As String)
        Try
            ...
            If saveFileDialog.ShowDialog() = DialogResult.OK Then
                ...
                Using connection As MySqlConnection = strdconection()
